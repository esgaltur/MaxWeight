...
public class WeekTest {
    ...
    public void testFromWeekNumberInvalid() {
        ...
        Exception exception1 = assertThrows(IllegalArgumentException.class, () -> {
            Week.fromWeekNumber(0);
        });
        assertTrue(exception1.getMessage().contains("Invalid week number"));

        // Test with week number greater than 6
        Exception exception2 = assertThrows(IllegalArgumentException.class, () -> {
            Week.fromWeekNumber(7);
        });
        assertTrue(exception2.getMessage().contains("Invalid week number"));
    }
